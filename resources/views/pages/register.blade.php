...
<head>
    <meta charset="utf-8">
    <title> A-Lex Commerce | Register </title>
                  ...
                  <form method="POST" action="{{route('register-user')}}">
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="/" class="">
                                <h6 class="text-primary"><i class="fa fa-user-edit me-2"></i>A-Lex Commerce </h6>
                            </a>
                            <h4>Sign Up</h4>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" name = "fullname" value="{{ old('fullname') }}" placeholder="Emmanuel Adebayor">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" name = "mobileno" value="{{ old('mobileno') }}" placeholder="+2347069178667">
                            <label for="floatingText">Mobile No</label>
                              @error('mobileno')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" name = "username" value="{{ old('username') }}" placeholder="jhondoe">

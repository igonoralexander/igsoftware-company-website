        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-th me-2"></i> Edit/Delete Posts </a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                    ...
                    @foreach($blogs as $blog)
                        <div class="col-12">
                            <div class="bg-secondary rounded-top p-4"> 
                                    ...
                                    <div class="mb-3">
                                        <img src="{{ asset($blog->imgBlog) }}" alt="{{$blog->title}}" width="500" height="300">
                                    </div>
                                        <p> {!! asset($blog->contents) !!} </p>
                                    <div class="mt-3 mb-3">

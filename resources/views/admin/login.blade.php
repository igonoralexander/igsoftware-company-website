...
<head>
    <meta charset="utf-8">
    <title> IG Software Nigeria | Admin Login </title>
                  ...
                  <form method="POST" action="{{route('admin-login')}}">
                      <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                          <div class="d-flex align-items-center justify-content-between mb-3">
                              <a href="/" class="">
                                  <h5 class="text-primary"><i class="fa fa-user-edit me-2"></i> </h5>
                              </a>
                              <h5>Admin Login</h5>
                          </div>
                          ...
                          <div class="form-floating mb-3">
                              <input type="text" class="form-control" id="floatingInput" name = "username" value="{{ old('username') }}" placeholder="name@example.com">
